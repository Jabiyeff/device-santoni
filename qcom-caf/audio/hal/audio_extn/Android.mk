...
LOCAL_C_INCLUDES := \
    ...
    device/xiaomi/santoni/qcom-caf/audio/hal \
...
LOCAL_C_INCLUDES := \
    ...
    $(call include-path-for, audio-route) \
    device/xiaomi/santoni/qcom-caf/audio/hal \
    device/xiaomi/santoni/qcom-caf/audio/hal/$(AUDIO_PLATFORM) \
    $(call include-path-for, audio-effects)
...
PRIMARY_HAL_PATH := device/xiaomi/santoni/qcom-caf/audio/hal
AUDIO_PLATFORM := $(TARGET_BOARD_PLATFORM)
...
LOCAL_C_INCLUDES := \
    ...
    $(call include-path-for, audio-route) \
    device/xiaomi/santoni/qcom-caf/audio/hal \
    device/xiaomi/santoni/qcom-caf/audio/hal/audio_extn \
    device/xiaomi/santoni/qcom-caf/audio/hal/$(AUDIO_PLATFORM) \
